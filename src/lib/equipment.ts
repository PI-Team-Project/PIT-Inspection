...
export const EQUIPMENT_LIST: Equipment[] = [
  { type: "Sit Down", flNumber: "R-MIT-0348", serial: "A4BC150348", makeColor: "Red Mitsubishi", contractType: "Rent", location: "Main WH" },
  { type: "Sit Down", flNumber: "R-MIT-0352", serial: "A4BC150352", makeColor: "Red Mitsubishi", contractType: "Rent", location: "Main WH" },
  { type: "Sit Down", flNumber: "M-MIT-0599", serial: "AFB30B50599", makeColor: "Mint Mitsubishi", contractType: "Rent", location: "Main WH" },
  { type: "Sit Down", flNumber: "M-MIT-0498", serial: "AFB2600498", makeColor: "Mint Mitsubishi", contractType: "Rent", location: "Main WH" },
  { type: "Sit Down", flNumber: "R-MIT-0204", serial: "AFB3050204", makeColor: "Red Mitsubishi", contractType: "Rent", location: "Main WH" },
  { type: "Sit Down", flNumber: "M-MIT-0270", serial: "EFB2600270", makeColor: "Mint Mitsubishi", contractType: "Rent", location: "Main WH" },
  { type: "Sit Down", flNumber: "M-MIT-0271", serial: "EFB2600271", makeColor: "Mint Mitsubishi", contractType: "Rent", location: "Main WH" },
  { type: "Sit Down", flNumber: "R-MIT-0351", serial: "A4BC150351", makeColor: "Red Mitsubishi", contractType: "Rent", location: "Main WH" },
  { type: "Propane", flNumber: "P-DOO-7108", serial: "FGA14-1290-07108", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI1 Electrode" },
  ...
  { type: "Standup", flNumber: "S-DOO-0082", serial: "FBA42-3440-00082", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI2 Form." },
  { type: "Standup", flNumber: "S-DOO-0125", serial: "FBA42-3440-00125", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI2 Form." },
  { type: "Standup", flNumber: "S-DOO-0083", serial: "FBA42-3440-00083", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI2 Form." },
  ...
  { type: "Sit Down", flNumber: "DOO-0885", serial: "FBA1B-1360-00885", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI4" },
  { type: "Sit Down", flNumber: "DOO-0884", serial: "FBA1B-1360-00884", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI3" },
  { type: "Sit Down", flNumber: "DOO-0887", serial: "FBA1B-1360-00887", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI4" },
  { type: "Sit Down", flNumber: "DOO-0889", serial: "FBA1B-1360-00889", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI4" },
  { type: "Standup", flNumber: "S-DOO-0134", serial: "FBA42-3440-00134", makeColor: "Orange Doosan", contractType: "Leasing", location: "MI4" },
  { type: "Standup", flNumber: "S-DOO-0124", serial: "FBA42-3440-00124", makeColor: "Orange Doosan", contractType: "Leasing", location: "Repairing" },
  ...
  { type: "Pallet Jack", flNumber: "BigJ-3449", serial: "4341503449", makeColor: "Big Joe", contractType: "Own", location: "MI1 Electrode" },
...
// Every distinct location actually in use, for the "where is it really"
// picker — derived from the fleet list itself so it can't drift out of
// sync with the locations equipment is actually assigned to.
export const LOCATIONS: string[] = Array.from(
  new Set(EQUIPMENT_LIST.map((eq) => eq.location))
).sort()
